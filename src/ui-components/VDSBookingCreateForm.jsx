...
export default function VDSBookingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLevels(initialValues.levels);
    setCurrentLevelsValue("");
    setAutos(initialValues.autos);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createVDSBooking.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "VDSBookingCreateForm")}
      {...rest}
    >
      <TextField
        label="Guests"
